...
void analyse_globals_include_globals(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "globals include globals");
    throw "analyse_globals_include_globals not implemented";
}
void analyse_globals_procedure_globals(ContextSensitiveTree* tree, const string& indent){

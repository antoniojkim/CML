...
void analyse_factor_NUM(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "factor NUM");
    throw "analyse_factor_NUM not implemented";
}
void analyse_factor_NONE_(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "factor NONE_");
    throw "analyse_factor_NONE_ not implemented";
}
void analyse_factor_NULLPTR(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "factor NULLPTR");
    throw "analyse_factor_NULLPTR not implemented";
}
void analyse_factor_TRUE_(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "factor TRUE_");
    throw "analyse_factor_TRUE_ not implemented";
}
void analyse_factor_FALSE_(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "factor FALSE_");
    throw "analyse_factor_FALSE_ not implemented";
}
void analyse_factor_ID(ContextSensitiveTree* tree, const string& indent){

...
void analyse_statement_dcl_SEMICOLON(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "statement dcl SEMICOLON");
    throw "analyse_statement_dcl_SEMICOLON not implemented";
}
void analyse_statement_IF_LPAREN_expr_RPAREN_LBRACE_statements_RBRACE_elseifstatement_elsestatement(ContextSensitiveTree* tree, const string& indent){
...
void analyse_statement_RETURN_expr_SEMICOLON(ContextSensitiveTree* tree, const string& indent){

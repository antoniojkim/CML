...
void analyse_type_BOOL(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "type BOOL");
    throw "analyse_type_BOOL not implemented";
}
void analyse_type_INT(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "type INT");
    throw "analyse_type_INT not implemented";
}
void analyse_type_LONG(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "type LONG");
    throw "analyse_type_LONG not implemented";
}
void analyse_type_LONG_LONG(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "type LONG LONG");
    throw "analyse_type_LONG_LONG not implemented";
}
void analyse_type_DOUBLE(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "type DOUBLE");
    throw "analyse_type_DOUBLE not implemented";
}
void analyse_type_FLOAT(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "type FLOAT");
    throw "analyse_type_FLOAT not implemented";
}
void analyse_type_ID(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "type ID");
    throw "analyse_type_ID not implemented";
}
void analyse_type_VOID(ContextSensitiveTree* tree, const string& indent){

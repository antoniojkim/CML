...
void analyse_expr6_expr5(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "expr6 expr5");
    throw "analyse_expr6_expr5 not implemented";
}
void analyse_expr6_expr6_PLUS_expr5(ContextSensitiveTree* tree, const string& indent){
    assert(tree->getParams()->rule == "expr6 expr6 PLUS expr5");
    throw "analyse_expr6_expr6_PLUS_expr5 not implemented";
}
void analyse_expr6_expr6_MINUS_expr5(ContextSensitiveTree* tree, const string& indent){
